...
class EventStartNotificationFirstMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'איזה כיף! האירוע מתקרב - ' . $this->event->name,
        );
    }
    ...
    {
        return new Content(
            view: 'mails.eventNotificationFirst',
            with: [
                'event' => $this->event,
