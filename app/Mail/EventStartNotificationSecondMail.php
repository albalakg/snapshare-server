...
class EventStartNotificationSecondMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'איזו התרגשות האירוע עומד להתחיל! - ' . $this->event->name,
        );
    }
    ...
    {
        return new Content(
            view: 'mails.eventNotificationSecond',
            with: [
                'event' => $this->event,
