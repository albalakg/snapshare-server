...
class EventNotification5Days extends Command
{
    protected $signature = 'event:notification-5-days';
    protected $description = 'Notify users 5 days before their event starts';
    ...
    public function handle()
    {
        ...
        $windowStart = $now->copy()->addDays(5)->startOfDay();
